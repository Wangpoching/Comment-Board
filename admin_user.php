<?php
  ...
  // 撈取所有會員
  $sql = "SELECT users.username as username, users.id as userId, roles.id as roleId
    FROM `users` 
...
<body>
  ...
  <nav class="sidebar">
    <div class="sidebar-section">
      ...
      <a href="admin_role.php" class="sidebar-item">
        <svg class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
          <path d="M12 2a4 4 0 1 0 0 8 4 4 0 0 0 0-8zM6 20v-1a6 6 0 0 1 12 0v1"/>
        </svg>
        身分管理
      </a>
      <a href="admin_user.php" class="sidebar-item active">
        <svg class="sidebar-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
  ...
  <main class="main">
    <div class="page-header">
      <div>
        ...
        <div class="page-subtitle">管理會員與對應的身分</div>
      </div>
    </div>
